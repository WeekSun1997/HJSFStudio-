...
layui.define(['laytpl', 'layer', 'element', 'util'], function (exports) {
    exports('setter', {
        ...
        , views: '/manage/views/' //视图所在目录
        , entry: 'index' //默认视图文件名
        , engine: '.html' //视图文件后缀名
        , pageTabs: true //是否开启页面选项卡功能。单页版不推荐开启

        , name: '<img src="/images/logo.png?t=2" style="height: 36px;"/>'
        ...
        //文件域名
        , fileDomain: 'https://localhost:44335'
        //api版本号
        , apiVersion: 'v1'
        //按钮获取URL
        , buttonGetUrl: 'syschannel/buttonlist'
