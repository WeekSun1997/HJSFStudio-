 ...
 * exports 可以把某个非requirejs方式的代码中的某一个全局变量暴露出去，当作该模块以引用
   paths: {
   	   'jquery': '/layuiadmin/lib/jquery/jquery.min',
   	   'gooflow': '/layuiadmin/lib/jquery/jquery.min',
   },
   shim: {
        'gooflow': {
            deps: ['/layuiadmin/lib/ueditor/ueditor.config.js', 'css!/layuiadmin/lib/ueditor/themes/default/css/ueditor']
            exports: 'GooFlow'
        }
    },
 */